...
function showCorrespondingW(phwId) {
    ...
    if (tardetsvg) {
      ...
      const textMap = {
        ...
        "11": ["寒冬時誕生、象徵堅強意志與生命的復甦", "始於清康熙，又稱「冰裂梅花紋」，\n描述冬季冰面裂紋與梅花盛開的景象。\n釉面在高溫燒製後形成自然的裂紋，稱為「開片」，\n再在其釉面繪上梅花或枝梅。"],
        "12": ["長壽之花，正直不屈、高雅純潔", "始於宋代，常被用於婚嫁或吉慶場合的器物裝飾。\n團菊紋的主體多數以對稱的形式呈現，花瓣層層疊疊，\n細線勾勒菊花輪廓，用填色或施釉技術增加立體感。\n以青花藍、釉裏紅、黃色為主，色彩鮮明而典雅。"],
